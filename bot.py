...
def get_main_menu_keyboard() -> InlineKeyboardMarkup:
    keyboard = [
        [
            ...
            InlineKeyboardButton('Историю первой любви', callback_data='story'),
            InlineKeyboardButton('Разницу между SQL и NoSQL', callback_data='difference'),
            InlineKeyboardButton('Пришлю ссылку на резюме', callback_data='resume'),
...
def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    message = get_message_text_from_db('start').format(name=update.effective_user.first_name)
